...
function Router() {
	...
	const [education, setEducation] = useState([
		...
		// startDate: '10/2010',
		// endDate: '05/2014',
		// description: 'Programming engineering and design',
		// id: 1,
		// },
		// {
		// degree: 'Bachelor of Science',
	...
	const [workExperience, setWorkExperience] = useState([
		...
		// 	workEndDate: '05/2014',
		// 	workDescription: 'Develop tests for software',
		// },
		// {
		// 	jobTitle: 'Software Engineer',
		// 	companyCity: 'Los Angeles',
	...
	const [resumeObjective, setResumeObjective] = useState({
		// objective:
		// 	'To obtain a position as a software engineer lorm ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
	})
